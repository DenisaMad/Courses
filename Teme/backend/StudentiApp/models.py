...
class Student(models.Model):
    ...
    an_universitar = models.ForeignKey(AnUniversitar,on_delete=models.CASCADE, null=False, blank=False) #am pus on delete=cascade ca imi dadea eroare, dar nu vad sensul de a sterge studentii daca se sterge profesorul
